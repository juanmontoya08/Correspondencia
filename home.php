...
if($role != 1 && $role != 2 && $role != 4)
	header('Location: index.php');
if($role = 3 && $role != 1 && $role != 2 && $role != 4)
...
<form action="" method="post">
	...
	<option value="00" id="00">Seleccione una opcion</option>
        ...
        <input type="submit" name="excel" value="EXCEL" class="btn btn-success" onclick=this.form.action="excelreporte.php">
        </form>
        </div>
		...
		<div class="wrapper-pad">
          ...
          <div class="info-box bg-gray">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Correspondencia total</span>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box bg-gray">
            ...
            <div class="info-box-content">
              <span class="info-box-text">CORRESPONDENCIA HOY</span>
              <span class="info-box-number"><?php echo $_home->get_new_items('hoy'); ?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
